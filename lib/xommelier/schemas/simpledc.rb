...
module Xommelier
  ...
  schema :xml, xmlns: {xs: "http://www.w3.org/2001/XMLSchema", dc: "http://purl.org/dc/elements/1.1/"}, elementFormDefault: "qualified", attributeFormDefault: "unqualified" do
    import "http://purl.org/dc/elements/1.1/", schemaLocation: "dc.xsd"
    element :simpledc, type: ns.dc.elementContainer
  end
end
